     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <!-- CONTACT FORM HERE -->
                         <form id="appointment-form" role="form" method="post" action="{{route('app.submit')}}">
                      @csrf
                              <!-- SECTION TITLE -->
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <textarea class="form-control" rows="5" id="message" name="address" placeholder="Address"></textarea>
...
<script>
     document.getElementById('hospitalselect').addEventListener('change',function(){
          ...
          .then(res=>res.json())
          .then(data=>{
               doctorselect.innerHTML="<option>Select Any Doctor</option>";
              data.forEach(d => {
